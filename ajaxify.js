      ...
      constructor() {
        ...
        this.a = function( o, p ) {
          ...
          if ( o === "=" ) history.replaceState( {
            url: $.currentURL
          }, "state-" + $.currentURL, $.currentURL ); //perform replaceState
          else if ( $.currentURL !== window.location.href ) history.pushState( {
            url: $.currentURL
          }, "state-" + $.currentURL, $.currentURL ); //perform pushState
        };
      }
    }
    ...
    class Pronto {
      constructor() {
        ...
        let _init_p = () => {
          ...
          _noAjaxy = () => {
            const selectors =
              typeof $.s.selectorskip === "string" && $.s.selectorskip.length > 0 ?
